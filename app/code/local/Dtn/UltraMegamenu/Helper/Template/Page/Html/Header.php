...
class Dtn_UltraMegamenu_Helper_Template_Page_Html_Header extends Mage_Core_Helper_Abstract
{
    /**
     ...
     * @var string
     */
    protected $_menuModuleName = 'Dtn_UltraMegamenu';
    protected $_menuModuleNameShort = 'ultramegamenu';

    /**
     * Main helper of the theme
     *
     * @var Dtn_Ultimo_Helper_Data
     */
    protected $theme;
    ...
    {
        $this->theme = Mage::helper('ultramegamenu/theme');
