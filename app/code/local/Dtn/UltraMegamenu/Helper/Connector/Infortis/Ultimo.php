...
class Dtn_UltraMegamenu_Helper_Connector_Infortis_Ultimo extends Mage_Core_Helper_Abstract
{
    /**
     * Module names
     */
    ...
    const HELPER_TEMPLATE_PAGE_HTML_HEADER = 'ultramegamenu/template_page_html_header';
